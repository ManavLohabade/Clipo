...
const Discover: React.FC = () => {
  ...
  const categories = [
    { id: "all", name: "All", icon: "🌟", count: campaigns.length },
    {
      ...
      name: "Clipping",
      icon: "✂️",
      count: campaigns.filter((c) => c.type === "Clipping").length,
    },
    {
      id: "ugc",
      name: "UGC",
      icon: "📱",
      count: campaigns.filter((c) => c.type === "UGC").length,
    },
    ...
    { id: "new", name: "New", icon: "🆕", count: 2 },
    {
      ...
      name: "Verified",
      icon: "✅",
      count: campaigns.filter((c) => c.verified).length,
    },
  ];
  ...
  const filteredCampaigns = campaigns.filter((campaign) => {
    ...
    const matchesCategory =
      ...
      (selectedCategory === "trending" &&
        trendingCampaigns.some((t) => t.brand === campaign.brand)) ||
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              <Link
                to="/discover"
                className="text-white font-medium border-b-2 border-purple-500 pb-1"
              >
                Discover
              </Link>
              <Link
              ...
              {user ? (
                ...
                <div className="flex items-center space-x-3">
                  <Link to="/register">
                    <Button
                      variant="outline"
                      className="border-gray-600 text-gray-300 hover:bg-gray-700 hover:text-white px-4 py-2 font-medium"
                    >
                      Sign up
                    </Button>
                  </Link>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8">
            ...
            <p className="text-xl md:text-2xl text-gray-300 leading-relaxed max-w-4xl mx-auto mb-8">
              Join thousands of creators who are already earning money by
              creating viral content. From sports clips to trading tips,
              monetize your passion with Clipper.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 mb-12">
              ...
              <Link to="/create-campaign">
                <Button
                  variant="outline"
                  className="border-2 border-gray-600 text-white hover:bg-gray-800 hover:border-gray-500 px-8 py-4 text-lg font-semibold bg-transparent"
                >
                  Create Campaign
                </Button>
              </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              We've built the most creator-friendly platform for monetizing your
              content
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center p-8 bg-gray-800 rounded-2xl border border-gray-700 hover:border-orange-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <p className="text-gray-400">
                Get paid immediately when your content reaches view milestones.
            ...
            <div className="text-center p-8 bg-gray-800 rounded-2xl border border-gray-700 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <p className="text-gray-400">
                Our AI matches you with campaigns that fit your content style
            ...
            <div className="text-center p-8 bg-gray-800 rounded-2xl border border-gray-700 hover:border-green-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <p className="text-gray-400">
                Your content is protected. We ensure fair compensation and
                transparent terms.
              </p>
            </div>
            ...
            <div className="text-center p-8 bg-gray-800 rounded-2xl border border-gray-700 hover:border-blue-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <p className="text-gray-400">
                Access campaigns from brands worldwide. Your content can reach
                millions of viewers.
              </p>
            </div>
            ...
            <div className="text-center p-8 bg-gray-800 rounded-2xl border border-gray-700 hover:border-pink-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <p className="text-gray-400">
                Track your performance with detailed analytics and insights to
            ...
            <div className="text-center p-8 bg-gray-800 rounded-2xl border border-gray-700 hover:border-yellow-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <p className="text-gray-400">
                Join our creator community for tips, collaboration
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-12">
            <div>
              ...
              <p className="text-xl text-gray-300">
                Hot opportunities that creators are loving right now
              </p>
            </div>
            <Link to="/content-rewards">
              <Button
                variant="outline"
                className="border-gray-600 text-white hover:bg-gray-800 hover:border-gray-500 px-6 py-3"
              >
                View All
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {trendingCampaigns.map((campaign) => (
              <Card
                key={campaign.id}
                className="bg-gradient-to-br from-gray-900 to-gray-800 border-orange-500/20 hover:border-orange-500/40 transition-all duration-300 hover:transform hover:scale-105 cursor-pointer"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-400">
                Explore thousands of campaigns from top brands. Filter by
                category, payout rate, and requirements.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">
                Use your creativity to make engaging content that matches the
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">
                Earn money based on views and engagement. Payouts are automatic
                and instant.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-gray-900 to-black">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join thousands of creators who are already making money with
            Clipper. Your next viral hit could be just one campaign away.
          </p>
