...
const ROLE_OPTIONS = [
  { value: 'brand', label: 'Brand', description: 'I want to create campaigns and work with creators' },
  { value: 'clipper', label: 'Creator', description: 'I want to create content and earn from campaigns' },
];
